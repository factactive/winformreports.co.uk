...
<html><!-- InstanceBegin template="/Templates/winformreports_aspx2.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
<!-- InstanceBeginEditable name="doctitle" -->
<title>WinForm Reports for .NET - Login</title>
<!-- InstanceEndEditable --> 
<meta https-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<style type="text/css">
<!--
td {  font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 8pt; color: #000000; font-weight: normal; line-height: normal}
th {  font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 8pt; color: #000000; font-weight: bold; line-height: normal}
...
p { font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 8pt; color: #666666; font-weight: normal; line-height: normal}
          ...
          <td align="left" valign="top"> 
            <table width="140" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                ...
                <td bgcolor="#F0F4F7">&nbsp;&nbsp;<img src="bullet.gif" width="6" height="7">&nbsp;<a href="login.aspx?logout=true">Logout</a></td>
...
ASP.NET</a></td>
  ...
  <tr>
    ...
    <td><input name="cmdSubmit" type="image" src="s_joinlist_btn.jpg" align="right" width="45" height="15" border="0"></td>
		...
		<tr>
		<td></td>
		<td><form name="ctl00" method="post" action="login.aspx?ReturnUrl=%2fUpdates%2fViewUpdates.aspx" id="ctl00">
<input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="UCDoLogin1$Login1$Button1" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJMjY1NjYwNzE5ZGTp/nllzilU+OsndGpO2P8G/q05QA==" />

		<!-- InstanceBeginEditable name="MainArea" -->
		    <p><img src="login.gif" width="54" height="21"></p>
		    <p>To access the secure portion of this site you must login using your email address and purchase order ID. <a href='Forgot.aspx'>Can't remember your order IDs?</a></p><p><strong>Note</strong>: the email address you enter must match the one you gave when ordering the product. If you unsure about the email address to use, please <a href='contactus.asp'>contact us</a>, providing as much detail about your order as possible and we will try and locate it.
		    <p><br><br></p>
...
<HTML>
	...
	<body MS_POSITIONING="FlowLayout">
			<P>
				<table id="UCDoLogin1_Login1_Table1">
	<tr>
		<TD>
			<span id="UCDoLogin1_Login1_Label1">Order email address:</span></TD>
		<TD>
			<input name="UCDoLogin1$Login1$TextBox1" type="text" id="UCDoLogin1_Login1_TextBox1" /></TD>
		<TD>
			&nbsp;</TD>
	</tr>
	<tr>
		<TD>
			<span id="UCDoLogin1_Login1_Label2">Order number/id:</span></TD>
		<TD>
			<input name="UCDoLogin1$Login1$TextBox2" type="text" id="UCDoLogin1_Login1_TextBox2" /></TD>
		<TD>
			&nbsp;</TD>
	</tr>
	<tr>
	...
	<tr>
		<TD></TD>
		<TD align="right">
			<input type="submit" name="UCDoLogin1$Login1$Button1" value="Login" onclick="javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;UCDoLogin1$Login1$Button1&quot;, &quot;&quot;, true, &quot;&quot;, &quot;&quot;, false, false))" id="UCDoLogin1_Login1_Button1" /></TD>
		<TD></TD>
	</tr>
</table>
...
<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEWBALmh/jACgL186mhCQL187WhCQK7vPDnB2nl6hYcHCpQC198BqiCWyB38S4o" /></form></td>
		</tr>
		</table>
  		</td>
        </tr>
